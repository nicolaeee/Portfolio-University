---
title: Examen semstru 2 Anul 1 PCLP
author: Gorobet Nicolae
---
# Here is the an example of the exam which I must do for PCLP 1
...
## Here is the implimentation on the page:
![photo](../../static/img/exam1-2.jpg);
