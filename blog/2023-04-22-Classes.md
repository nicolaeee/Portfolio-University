---
title: Classes and example
author: Gorobet Nicolae
---

# What is a class in programming?

A class is a programming construct that allows the user to define a blueprint for creating objects that have certain properties and methods. It provides a way to encapsulate data and functionality, making it easier to organize and maintain code. In short, a class is a template for creating objects in programming


## Here is a bigger problem on the class with a few methods
```
#include <iostream>
#include <string>
using namespace std;
